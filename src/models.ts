...
export const modelFamilies: ModelFamily[] = [
  ...
  },
  {
    ...
    versions: [
      ...
      { id: "nb-pro", name: "Nano Banana Pro", releaseDate: "2025-11", description: "Gemini 3 Pro Image，旗舰档位。", descriptionEn: "Gemini 3 Pro Image, flagship tier.", active: false, scenes: ["文生图", "图生图与编辑"], apiPrices: [{ label: "标准 1K/2K", price: "≈$0.134/张" }, { label: "标准 4K", price: "≈$0.24/张" }] },
