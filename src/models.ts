...
export interface ModelVersion {
  ...
  active: boolean;
  /** API 价格档位（结构化，无公开定价可省略） */
  apiPrices?: ApiPriceTier[];
  /** 场景标签 */
  scenes: string[];
}

export interface ApiPriceTier {
  /** 档位标签（如 "Large" / "1024² 低质"） */
  label: string;
  /** 档位标签（英文，可省略） */
  labelEn?: string;
  /** 价格（如 "$0.065/张"） */
...
export const modelFamilies: ModelFamily[] = [
  {
    ...
    versions: [
      ...
      { id: "v8-2", name: "V8.2", releaseDate: "2026-07", description: "当前最新版本，色彩与光影进一步优化。", descriptionEn: "Latest version with refined color and lighting.", active: true, scenes: ["文生图", "插画创作"], apiPrices: [{ label: "Base", price: "$10/月", note: "约 200 张/月，订阅制无 API" }] },
    ],
  },
  {
    id: "stable-diffusion",
  ...
  },
  {
    ...
    versions: [
      { id: "flux-1", name: "FLUX.1", releaseDate: "2024-08", description: "开源基座（dev/schnell），社区生态爆发。", descriptionEn: "Open base models (dev/schnell) that ignited the community.", active: true, scenes: ["文生图", "图生图与编辑"], apiPrices: [{ label: "Pro", price: "$0.05/MP" }, { label: "Dev", price: "$0.025/MP" }] },
      ...
      { id: "flux-2", name: "FLUX.2", releaseDate: "2025-11", description: "新一代架构，排版与真实感再升级。", descriptionEn: "Next-gen architecture with better typography and realism.", active: true, scenes: ["文生图", "海报与平面设计"], apiPrices: [{ label: "Pro", price: "$0.03/MP" }, { label: "Flex", price: "$0.05/MP" }] },
      { id: "flux-2-max", name: "FLUX.2 Max", releaseDate: "2025-12", description: "旗舰档位，最高质量输出。", descriptionEn: "Flagship tier with the highest quality output.", active: false, scenes: ["文生图"], apiPrices: [{ label: "Max", price: "$0.07/MP 起" }] },
      { id: "flux-2-klein", name: "FLUX.2 Klein", releaseDate: "2026-01", description: "轻量 4B/9B 模型，本地运行友好。", descriptionEn: "Lightweight 4B/9B models, local-friendly.", active: true, scenes: ["文生图"], apiPrices: [{ label: "Klein 9B", price: "$0.015+/MP" }, { label: "Klein 4B", price: "$0.014+/MP" }] },
  ...
  },
  {
    ...
    versions: [
      ...
      { id: "gpt-image-1", name: "GPT Image", releaseDate: "2025-03", description: "对话式生成，取代 DALL-E 3。", descriptionEn: "Conversational generation, replacing DALL-E 3.", active: true, scenes: ["文生图", "图生图与编辑"] },
      { id: "gpt-image-1-5", name: "GPT Image 1.5", releaseDate: "2025-12", description: "旗舰档位（gpt-image-1.5），token 计价，质量档决定成本。", descriptionEn: "Flagship tier (gpt-image-1.5), billed per token with quality tiers.", active: true, scenes: ["文生图", "图生图与编辑"], apiPrices: [{ label: "1024² 低质", labelEn: "1024² low", price: "≈$0.009/张" }, { label: "1024² 中质", labelEn: "1024² medium", price: "≈$0.034/张" }, { label: "1024² 高质", labelEn: "1024² high", price: "≈$0.133/张" }] },
      { id: "gpt-image-2", name: "GPT Image 2", releaseDate: "2026-04", description: "当前最新版本，速度与细节全面提升，集成于 ChatGPT 与 API。", descriptionEn: "Latest version with faster, more detailed generation, in ChatGPT and the API.", active: true, scenes: ["文生图", "图生图与编辑", "海报与平面设计"], apiPrices: [{ label: "1024² 低质", labelEn: "1024² low", price: "≈$0.006/张" }, { label: "1024² 中质", labelEn: "1024² medium", price: "≈$0.053/张" }, { label: "1024² 高质", labelEn: "1024² high", price: "≈$0.211/张" }] },
    ],
  },
  {
    id: "nano-banana",
    ...
    versions: [
      ...
      { id: "nb-pro", name: "Nano Banana Pro", releaseDate: "2025-11", description: "Gemini 3 Pro Image，旗舰档位。", descriptionEn: "Gemini 3 Pro Image, flagship tier.", active: true, scenes: ["文生图", "图生图与编辑"], apiPrices: [{ label: "标准 1K/2K", price: "≈$0.134/张" }, { label: "标准 4K", price: "≈$0.24/张" }] },
      { id: "nb-2", name: "Nano Banana 2", releaseDate: "2026-02", description: "Gemini 3.1 Flash Image，主流档位。", descriptionEn: "Gemini 3.1 Flash Image, mainstream tier.", active: true, scenes: ["文生图", "图生图与编辑", "人像写真"], apiPrices: [{ label: "1K", price: "≈$0.067/张" }, { label: "2K", price: "≈$0.101/张" }, { label: "4K", price: "≈$0.151/张" }] },
      { id: "nb-2-lite", name: "Nano Banana 2 Lite", releaseDate: "2026-06", description: "轻量档位，速度优先，成本更低。", descriptionEn: "Lite tier, speed-first and lower cost.", active: true, scenes: ["文生图"], apiPrices: [{ label: "Lite", price: "低于标准档" }] },
    ],
  },
  {
    id: "seedream",
  ...
  },
  {
    ...
    versions: [
      ...
      { id: "qwen-image-3", name: "Qwen-Image 3.0", releaseDate: "2026-07", description: "当前最新，3.0/3.0-Pro 上线千问与百炼 API。", descriptionEn: "Latest release; 3.0/3.0-Pro live on Qwen and Bailian API.", active: true, scenes: ["文生图", "海报与平面设计", "电商与产品"], apiPrices: [{ label: "qwen-image", price: "¥0.25/张" }] },
    ],
  },
  {
    id: "hunyuan",
  ...
  },
  {
    ...
    versions: [
      ...
      { id: "ideogram-3", name: "3.0", releaseDate: "2025-03", description: "真实感与排版再升级。", descriptionEn: "Further realism and typography gains.", active: true, scenes: ["文生图"] },
      { id: "ideogram-4", name: "4.0", releaseDate: "2026-06", description: "首个开源权重版本（9.3B、原生 2K），支持 JSON Prompts。", descriptionEn: "First open-weights release (9.3B, native 2K) with JSON Prompts.", active: true, scenes: ["文生图", "海报与平面设计"], apiPrices: [{ label: "Turbo", price: "$0.03/张" }, { label: "Default", price: "$0.06/张" }, { label: "Quality", price: "$0.10/张" }] },
    ],
  },
  {
    id: "recraft",
    ...
    platforms: ["recraft"],
    versions: [
      { id: "recraft-v3", name: "Recraft V3", releaseDate: "2024-10", description: "曾连续五个月在 Artificial Analysis 公开基准排名第一，真实感与文字渲染重大进步。", descriptionEn: "Topped the Artificial Analysis public benchmark for five straight months; major gains in photorealism and text rendering.", active: true, scenes: ["插画创作", "海报与平面设计"], apiPrices: [{ label: "V3", price: "$0.04/张" }, { label: "V3 Vector", price: "$0.08/张" }] },
      { id: "recraft-v4-1", name: "Recraft V4.1", releaseDate: "2026-05", description: "当前最新，主打更自然的画面感，价格较 V4 下调。", descriptionEn: "Latest release with a more natural look; price cut vs V4.", active: true, scenes: ["插画创作", "海报与平面设计"], apiPrices: [{ label: "V4.1", price: "$0.035/张" }, { label: "V4.1 Pro", price: "$0.21/张" }, { label: "V4.1 Vector", price: "$0.08/张" }, { label: "V4.1 Pro Vector", price: "$0.30/张" }] },
      { id: "recraft-v4", name: "Recraft V4", releaseDate: "2026-02", description: "上一代，注重视觉与设计品味，支持可编辑 SVG 矢量与 2048² 原生分辨率。", descriptionEn: "Previous gen focused on visual taste, with editable SVG vectors and 2048² native resolution.", active: false, scenes: ["插画创作", "海报与平面设计"], apiPrices: [{ label: "V4", price: "$0.04/张" }, { label: "V4 Pro", price: "$0.25/张" }, { label: "V4 Vector", price: "$0.08/张" }, { label: "V4 Pro Vector", price: "$0.30/张" }] },
    ],
  },
  {
    id: "phoenix",
    ...
    versions: [
      ...
      { id: "phoenix-1", name: "Phoenix 1.0", releaseDate: "2025", description: "旗舰模型（phoenix-v1.0），游戏美术与概念设计专用，官方未公开精确首发日期。", descriptionEn: "Flagship model (phoenix-v1.0) for game art and concept design; exact release date not officially published.", active: true, scenes: ["文生图", "插画创作", "图生图与编辑"], apiPrices: [{ label: "PAYG", price: "动态计费", note: "官方价格计算器" }] },
    ],
  },
  {
    id: "firefly",
    ...
    versions: [
      ...
      { id: "firefly-4", name: "Image 4", releaseDate: "2025-04", description: "真实感大幅提升。", descriptionEn: "Major realism gains.", active: true, scenes: ["文生图"] },
...

  {
    ...
    logoDomain: "x.ai",
    logoFile: "xai.png",
    intro: "xAI 对话助手的自研图像生成系列，API 按张计费，有标准/高质量两档。",
    introEn: "xAI assistant's in-house image series; per-image API pricing with standard and quality tiers.",
    platforms: ["grok"],
    versions: [
      { id: "imagine-1", name: "Imagine 1.0", releaseDate: "2026-02", description: "内置 Chibi 等风格模板。", descriptionEn: "With Chibi and other style templates.", active: true, scenes: ["文生图", "图生图与编辑"], apiPrices: [{ label: "标准", labelEn: "Standard", price: "$0.02/张" }, { label: "高质量", labelEn: "Quality", price: "$0.05-0.07/张" }] },
      { id: "imagine-1-5", name: "1.5 Preview", releaseDate: "2026-06", description: "预览版，质量提升。", descriptionEn: "Preview with quality improvements.", active: true, scenes: ["文生图"] },
    ],
  },
  {
    id: "kolors",
    name: "Kolors 可图",
    developer: "快手",
    developerEn: "Kuaishou",
    logoDomain: "klingai.com",
    logoFile: "klingai.png",
    intro: "快手开源文生图模型（类 SD 架构），2.0 主打指令遵循与电影质感，Kling 平台提供。",
    introEn: "Kuaishou's open text-to-image model (SD-like), 2.0 focuses on instruction following and cinematic look, on Kling.",
    platforms: ["klingai"],
    versions: [
      { id: "kolors-1", name: "Kolors 1.0", releaseDate: "2024-07", description: "开源基座。", descriptionEn: "Open base release.", active: false, scenes: ["文生图"] },
      { id: "kolors-2", name: "Kolors 2.0", releaseDate: "2025-04", description: "指令遵循与电影质感，Kling 平台图片模型。", descriptionEn: "Better instruction following and cinematic look; Kling image model.", active: true, scenes: ["文生图", "人像写真"], apiPrices: [{ label: "Kling Image 3.0", price: "$0.028/张", note: "Kling API" }] },
    ],
  },
  {
    id: "magnific-models",
    ...
    logoFile: "magnific.png",
    intro: "Freepik（2026 更名 Magnific）素材平台的自研模型系列，按官方积分计费。",
    introEn: "Freepik's (Magnific since 2026) in-house model series, billed in official credits.",
    platforms: ["magnific"],
    versions: [
      { id: "mystic-1", name: "Mystic 1.0", releaseDate: "2024-08", description: "初代旗舰。", descriptionEn: "First flagship.", active: false, scenes: ["文生图"], apiPrices: [{ label: "Mystic 1.0", price: "45 credits" }] },
      { id: "mystic-2-5", name: "Mystic 2.5", releaseDate: "2024-11", description: "当前旗舰，含 Flexible/Fluid 变体。", descriptionEn: "Current flagship, with Flexible/Fluid variants.", active: true, scenes: ["文生图", "海报与平面设计"], apiPrices: [{ label: "Mystic 2.5", price: "50 credits" }, { label: "Flexible/Fluid", price: "80 credits" }] },
  ...
  },
  {
    ...
    logoDomain: "krea.ai",
    logoFile: "krea.png",
    intro: "Krea 首个自有基础图像模型，订阅制，另有 Freepik 积分交叉印证。",
    introEn: "Krea's first in-house base image model; subscription-based, cross-checked with Freepik credits.",
    platforms: ["krea"],
    versions: [
      { id: "krea-2", name: "Krea 2", releaseDate: "2026-05", description: "自有基础模型（Medium/High 档）。", descriptionEn: "In-house base model (Medium/High tiers).", active: true, scenes: ["文生图", "图生图与编辑"], apiPrices: [{ label: "Krea 2 Medium", price: "80 credits" }, { label: "Basic", price: "$5.25/月" }, { label: "Pro", price: "$21/月" }] },
    ],
  },
  {
    id: "playground-models",
    name: "Playground",
    developer: "Playground AI",
    developerEn: "Playground AI",
    logoDomain: "playground.com",
    logoFile: "playground.png",
    intro: "为平面设计打造的文生图平台，订阅制。",
    introEn: "Text-to-image platform built for graphic design; subscription-based.",
    platforms: ["playground"],
    versions: [
      { id: "pg-v3", name: "V3", releaseDate: "2024-10", description: "平面设计向（PGv3）。", descriptionEn: "Graphic-design-focused (PGv3).", active: true, scenes: ["文生图", "海报与平面设计"], apiPrices: [{ label: "Free", price: "每 3 小时 5 张" }, { label: "Pro", price: "$15/月" }, { label: "Pro Plus", price: "$45/月" }] },
    ],
  },
