          ...
          >
            ...
            <div className="px-6 pb-2">
              {countdown !== null && countdown > 0 && (
                <p className="text-xs text-stone-500 whitespace-nowrap overflow-hidden text-ellipsis">
                  {labels.disclaimerCountdown(getToolDomain(tool.url), countdown)}
                </p>
              )}
            </div>

            <div className="flex justify-end items-center gap-3 p-6 pt-3">
              <button
                onClick={onClose}
                className="px-4 py-2 text-stone-600 hover:text-stone-900 transition-colors whitespace-nowrap"
              >
              ...
              {countdown !== null && (
                <button
                  onClick={jumpNow}
                  className="flex items-center gap-2 px-6 py-2 bg-stone-900 text-white rounded-lg hover:bg-stone-800 transition-colors whitespace-nowrap"
                >
