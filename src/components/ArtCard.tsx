  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-3 translate-y-1 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
        <span className="text-[9px] font-semibold tracking-widest text-white/80 uppercase mb-1 block drop-shadow-sm">
          {labels.categoryMap[art.category] || art.category}
        </span>
        <h3 className="text-sm font-serif text-white font-medium drop-shadow-md leading-tight line-clamp-1">
          {displayTitle}
        </h3>
      </div>
    </div>
